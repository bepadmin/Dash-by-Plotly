...
if os.path.exists('output.csv'):
    past_data = pd.read_csv('output.csv')
else:
    past_data = pd.read_csv('past_data.csv') # whatever the name of the csv file holding the initial historical data
...
def update_graph_scatter(n):
    ...
    if status == True:
        ...
        past_data.to_csv('output.csv',index = False)
